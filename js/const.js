...
const questions = [
  ...
  [
    ...
    ["this.score.protoss--", "this.score.protoss--", "this.score.protoss++"],
  ],

  [
    "Перед вами хорошо укреплённый терранский бункер",
    [
      "Я ассимилирую эссенцию тиранозора, который обитает в этих местах и эволюционирую",
      "Запрошу орбитальный удар если они первые проявят агрессию",
      "Подойду поговорить с морпехами",
    ],
    [
      "this.score.primal++; this.score.protoss--; this.score.terran--",
      "this.score.protoss++; this.score.terran--",
  ...
  [
    "На вас напали",
    [
      "Нам нужны роевики, споровики и плёточники",
      "Нужно вызвать кайдариновые монолиты и фотонные пушки",
      "Возвести планетарную крепость, бункеры и подвести осадные танки",
    ],
    [
  ...
  [
    ...
    [
      "Должен подчиниться",
      "Пока она собирает, я следую",
      "Её псионная сила на меня не действует",
    ],
    [
  ...
  [
    ...
    [
      "Сильная эссенция, но я не могу её собрать",
      "Уничтожить протоссов",
      "Стать архонтом",
      "Спросить как дела у Артаниса",
    ],
    [
      "this.score.primal++; this.score.protoss--; this.score.terran--",
  ...
  [
    ...
    ["this.score.terran++", "this.score.terran--"],
  ],
  [
    "На вас движется стая саранчидов",
    [
      "Много эссенции, можно собрать",
      "Приказать им лететь дальше",
      "Попытаться уничтожить фениксами пока они в воздухе",
    ],
    [
      "this.score.primal++; this.score.protoss--",
      "this.score.zerg++; this.score.protoss--",
  ...
  [
    ...
    [
      "Соберу много эссенции",
      "Моё тело не выдержит такую мощь",
      "Попытаюсь уничтожить это место",
    ],
    [
      "this.score.primal++; this.score.protoss--",
      "this.score.zerg++; this.score.protoss--",
  ...
  [
    ...
    [
      "Вызвать на Рак-шир",
      "Поприветствовать фразой «Эн Таро Тассадар»",
      "Отправить рой в атаку",
    ],
    [
  ...
  [
    ...
    [
      "Защищать месторождения от инопланетных захватчиков",
      "Добыть как можно больше, пока эти Талдаримские живчики не успели ничего понять",
    ],
    ["this.score.taldarim++; this.score.terran--", "this.score.terran++"],
  ],
  [
    "В лаборатории ставят опыты над бруталиском",
    [
      "Бруталиск – вершина эволюции, нужен рою",
      "Поинтересоваться у парней, что интересного они узнали",
      "Бруталиск очень опасен лучше уничтожить его вместе с терранской лабораторией",
    ],
    [
      "this.score.zerg++; this.score.protoss--; this.score.terran--",
      "this.score.terran++; this.score.protoss--; this.score.zerg--",
  ...
  [
    ...
    ["this.score.terran--", "this.score.terran--", "this.score.terran++"],
  ],
  [
    "Феникс - ",
  ...
  [
    ...
    [
      "Использую гиперпрыжок",
      "Перехвачу его, внедрив паразит",
      "Отправлю челнок с посланием",
    ],
    [
  ...
  [
    ...
    [
      "Нужно уничтожить всех, чтобы эпидемия не распространилась",
      "Сжечь только зараженные строения и спасти как можно больше людей",
    ],
    [
      "this.score.protoss++; this.score.terran--",
      "this.score.terran++; this.score.protoss--",
  ...
  [
    ...
    [
      "Нанять лучших головорезов доминиона",
      "Усовершенствовать технологии",
      "Отправить их в фонд Мёбиуса для изучения гибридов",
    ],
    ["this.score.terran++", "this.score.terran+=2", "this.score.terran--"],
  ],
  [
    "Амун собирается уничтожить Айур",
    [
      "Помочь протоссам в битве",
      "Послать челноки на Шакурас и запросить помощь Золотой Армады",
      "Вызвать Флот Смерти и дать Амуну бой",
    ],
    [
      "this.score.terran++; this.score.protoss--",
      "this.score.protoss++; this.score.zerg--",
  ...
  [
    ...
    [
      "Выследить и убить королеву клинков",
      "Найти Керриган и убедить вернуться на Мар-Сару",
      "Искупаться в слизи",
    ],
    [
      "this.score.protoss++; this.score.terran--; this.score.zerg-=2",
...
const results = {
  zerg: {
    name: "Зерг",
    description:
      "Вы истинный зерг, чистота эссенции и служение во славу роя это ваше предназначение. Ваша стая захватила множество миров и теперь рой стал ещё сильней. Королева Клинков довольна вами, продолжайте и дальше служить ей. Вы уважаете протоссов, но не считаете что у них есть шанс сохраниться как вид. Ведь они не могут эволюционировать и в масштабах вселенной их раса обречена на вымирание. Тераны это биомасса, их эссенция может быть ассимилирована и использована во благо роя.",
    quote1:
      "-Понятие совершенства растяжимо. Можно стремиться, невозможно достичь. Совершенство, как цель, лишено смысла.",
  ...
  infested: {
    ...
    description:
      "Судя по всему вас заразили зерги, теперь вы служите рою. Но это не мешает вам мечтать о мести зергам.",
  ...
  taldarim: {
    name: "Талдарим",
    description:
      "В былые времена вы служили Амуну, падшему Зел-Нага, сейчас же ваш народ обрёл свободу. После того как Аларак стал владыкой талдаримов победив Малаша в поединке Рак-Шир, он не просто изменил свой статус в цепи вознесения, но и привел талдаримов к мирному сосуществованию с другими народами протоссов. Теперь можно восстанавливать свои миры как один единый сильный народ. И ваши навыки будут очень полезны в этой непростой задаче.",
